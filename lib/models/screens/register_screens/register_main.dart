...
import 'package:transactions_app/models/screens/register_screens/register_email.dart';
import 'package:transactions_app/utils/constants.dart';
import 'package:transactions_app/widgets/onboarding_app_bar.dart';
        ...
        Padding(
          ...
          child: Column(
            children: [
              ...
              Padding(
                padding:
                    EdgeInsets.only(top: Sizes.size12, bottom: Sizes.size32),
                child: Text(
