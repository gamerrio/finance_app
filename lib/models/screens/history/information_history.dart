...
class HistoryInformationState extends State<HistoryInformation> {
  ...
  void _onSelectionChanged(DateRangePickerSelectionChangedArgs args) async {
    ...
    if (endDate != 'null') {
      List newHistory =
          await AuthService().getTransactionHistoryByDate(startDate, endDate);
                        ...
                        children: [
                          Padding(
                            padding: EdgeInsets.only(
                                top: Sizes.size24, bottom: Sizes.size8),
                            child: const Text(
                              'Accumulated funds',
                          ...
                          Padding(
                            padding:
                                EdgeInsets.symmetric(vertical: Sizes.size32),
                            child: Row(
                          ...
                          _history!.isEmpty
                              ...
                              : ListView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    return Padding(
                                      padding:
                                          EdgeInsets.only(bottom: Sizes.size16),
                                      child: Row(
                                        mainAxisAlignment:
