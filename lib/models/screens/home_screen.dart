...
import 'package:transactions_app/models/screens/request_money.dart';
import 'package:transactions_app/models/screens/send_money/send_money.dart';
import 'package:transactions_app/utils/constants.dart';
import 'package:transactions_app/widgets/home_app_bar.dart';
          ...
          children: [
            Column(
              children: [
                Padding(
                  padding:
                      EdgeInsets.only(top: Sizes.size16, bottom: Sizes.size8),
                  child: Align(
                ...
                Padding(
                  padding:
                      EdgeInsets.only(top: Sizes.size32, bottom: Sizes.size20),
                  child: Row(
            ...
            child: Column(
              children: [
                ...
                Align(
                    ...
                    child: Text(Strings.letsConnect)),
                Padding(
                  padding:
                      EdgeInsets.only(top: Sizes.size16, right: Sizes.size16),
                  child: Align(
                    alignment: Alignment.topRight,
                    child: Text(
          ...
          child: Card(
            child: Column(
              children: [
                  ...
                  children: [
                    ...
                    Column(
                      children: [
                        Padding(
                          padding: EdgeInsets.only(
                              top: Sizes.size16, right: Sizes.size16),
                          child: Align(
                            alignment: Alignment.topRight,
                            child: Image.asset(
                              ImagePaths.cardLogo,
                        ...
                        Padding(
                          padding: EdgeInsets.only(
                              top: Sizes.size53, left: Sizes.size12),
                          child: const Align(
                              alignment: Alignment.centerLeft,
                              child: Text(
                                'Biancalize',
                ...
                Padding(
                  padding:
                      EdgeInsets.only(top: Sizes.size8, left: Sizes.size12),
                  child: Align(
                    alignment: Alignment.topLeft,
